...
/// @nodoc
abstract class _$$_TmdbResultCopyWith<$Res>
    implements $TmdbResultCopyWith<$Res> {
  factory _$$_TmdbResultCopyWith(
          _$_TmdbResult value, $Res Function(_$_TmdbResult) then) =
      __$$_TmdbResultCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {Dates? dates,
...
/// @nodoc
class __$$_TmdbResultCopyWithImpl<$Res>
    extends _$TmdbResultCopyWithImpl<$Res, _$_TmdbResult>
    implements _$$_TmdbResultCopyWith<$Res> {
  __$$_TmdbResultCopyWithImpl(
      _$_TmdbResult _value, $Res Function(_$_TmdbResult) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_TmdbResult implements _TmdbResult {
  _$_TmdbResult(
      {this.dates,
      this.page,
  ...
  factory _$_TmdbResult.fromJson(Map<String, dynamic> json) =>
      _$$_TmdbResultFromJson(json);
  ...
  @override
  String toString() {
    return 'TmdbResult(dates: $dates, page: $page, totalPages: $totalPages, totalResults: $totalResults, results: $results)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, dates, page, totalPages,
      totalResults, const DeepCollectionEquality().hash(_results));

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_TmdbResultCopyWith<_$_TmdbResult> get copyWith =>
      __$$_TmdbResultCopyWithImpl<_$_TmdbResult>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_TmdbResultToJson(
      this,
    );
  }
}
...
abstract class _TmdbResult implements TmdbResult {
  factory _TmdbResult(
      ...
      final List<TmdbMovie>? results}) = _$_TmdbResult;

  factory _TmdbResult.fromJson(Map<String, dynamic> json) =
      _$_TmdbResult.fromJson;
